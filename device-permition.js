...
module.exports.Component = registerComponent('device-orientation-permission-ui', {
  schema: {
    ...
    deviceMotionMessage: {
      default: 'Este site imersivo requer acesso aos sensores de movimento do dispositivo.'
    },
    mobileDestkopMessage: {
      default: 'Configure seu navegador para solicitar a versão móvel do site e recarregue a página para desfrutar do modo imersivo.'
    },
    httpsMessage: {
      default: 'Acesse este site por HTTPS para entrar no modo VR e conceder acesso aos sensores do dispositivo.'
    },
